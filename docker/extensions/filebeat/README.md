...
The Filebeat configuration is stored in [`config/filebeat.yml`](IdeaProjects/microservices-task/docker/extensions/filebeat/config/filebeat.yml). You can modify this file with
