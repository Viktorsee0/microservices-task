...
The Metricbeat configuration is stored in [`config/metricbeat.yml`](IdeaProjects/microservices-task/docker/extensions/metricbeat/config/metricbeat.yml). You can modify this file
